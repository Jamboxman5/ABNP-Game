...
public class PistolTec9 extends Firearm {
	...
	public PistolTec9(WeaponModLoadout mods, Ammo ammo, int loadedAmmo, String id) {
		...
		this.type = me.jamboxman5.abnpgame.weapon.WeaponType.TEC9;
		this.xOffset = 0;
		this.yOffset = 14;
	...
	public static void loadAssets(AssetManager assets) {
		// Sprites (Textures)
		assets.load("weapon/pistol/Tec-9.png", Texture.class);
		...
		// Sounds
		assets.load("sound/sfx/weapon/pistol/Pistol_Tec-9_Shot.wav", Sound.class);
	...
	public static void loadSprites(AssetManager assets) {
		hudSprite = setup("weapon/pistol/Tec-9.png", assets, .1f);
		...
		attackSound = assets.get("sound/sfx/weapon/pistol/Pistol_Tec-9_Shot.wav", Sound.class);
