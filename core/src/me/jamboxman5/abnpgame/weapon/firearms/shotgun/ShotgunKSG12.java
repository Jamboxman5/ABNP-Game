...
public class ShotgunKSG12 extends Firearm {
	...
	public ShotgunKSG12(WeaponModLoadout mods, Ammo ammo, int loadedAmmo, String id) {
		...
		this.type = me.jamboxman5.abnpgame.weapon.WeaponType.KSG12;
		this.xOffset = 9;
		this.yOffset = 12;
	...
	public static void loadAssets(AssetManager assets) {
		// Sprites (Textures)
		assets.load("weapon/shotgun/KSG-12.png", Texture.class);
		...
		// Sounds
		assets.load("sound/sfx/weapon/shotgun/Shotgun_KSG-12_Shot.wav", Sound.class);
	...
	public static void loadSprites(AssetManager assets) {
		hudSprite = setup("weapon/shotgun/KSG-12.png", assets, .15f);
		...
		attackSound = assets.get("sound/sfx/weapon/shotgun/Shotgun_KSG-12_Shot.wav", Sound.class);
