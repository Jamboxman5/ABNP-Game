...
public class ShotgunAssault extends Firearm {
	...
	public ShotgunAssault() {
		this(new WeaponModLoadout(), new ShellAmmo(), 8, UUID.randomUUID().toString());
	}

	public ShotgunAssault(WeaponModLoadout mods, Ammo ammo, int loadedAmmo, String id) {
		...
		this.type = me.jamboxman5.abnpgame.weapon.WeaponType.ASSAULTSHOTGUN;
		this.xOffset = 9;
		this.yOffset = 12;
	...
	public static void loadAssets(AssetManager assets) {
		// Sprites (Textures)
		assets.load("weapon/shotgun/AssaultShotgun.png", Texture.class);
		...
		// Sounds
		assets.load("sound/sfx/weapon/shotgun/Assault_Shotgun_Shot.wav", Sound.class);
	...
	public static void loadSprites(AssetManager assets) {
		hudSprite = setup("weapon/shotgun/AssaultShotgun.png", assets, .15f);
		...
		attackSound = assets.get("sound/sfx/weapon/shotgun/Assault_Shotgun_Shot.wav", Sound.class);
