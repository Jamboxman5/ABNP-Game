...
public class ShotgunSawnOff extends Firearm {
	...
	public ShotgunSawnOff() {
		this(new WeaponModLoadout(), new ShellAmmo(), 2, UUID.randomUUID().toString());
	}

	public ShotgunSawnOff(WeaponModLoadout mods, Ammo ammo, int loadedAmmo, String id) {
		...
		this.type = me.jamboxman5.abnpgame.weapon.WeaponType.SAWNOFF;
		this.xOffset = 9;
		this.yOffset = 12;
	...
	public static void loadAssets(AssetManager assets) {
		// Sprites (Textures)
		assets.load("weapon/shotgun/SawnOff.png", Texture.class);
	...
	public static void loadSprites(AssetManager assets) {
		hudSprite = setup("weapon/shotgun/SawnOff.png", assets, .15f);
