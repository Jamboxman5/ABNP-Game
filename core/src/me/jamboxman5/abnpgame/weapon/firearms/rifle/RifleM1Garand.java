...
public class RifleM1Garand extends Firearm {
	...
	public RifleM1Garand() {
		this(new WeaponModLoadout(), new StandardAmmo(), 8, UUID.randomUUID().toString());
	}

	public RifleM1Garand(WeaponModLoadout mods, Ammo ammo, int loadedAmmo, String id) {
		...
		this.type = me.jamboxman5.abnpgame.weapon.WeaponType.M1GARAND;
		this.xOffset = 9;
		this.yOffset = 12;
	...
	public static void loadAssets(AssetManager assets) {
		// Sprites (Textures)
		assets.load("weapon/rifle/M1Garand.png", Texture.class);
		...
		assets.load("sound/sfx/weapon/rifle/Rifle_M1Garand_Shot.wav", Sound.class);
	...
	public static void loadSprites(AssetManager assets) {
		hudSprite = setup("weapon/rifle/M1Garand.png", assets, .15f);
		...
		attackSound = assets.get("sound/sfx/weapon/rifle/Rifle_M1Garand_Shot.wav", Sound.class);
